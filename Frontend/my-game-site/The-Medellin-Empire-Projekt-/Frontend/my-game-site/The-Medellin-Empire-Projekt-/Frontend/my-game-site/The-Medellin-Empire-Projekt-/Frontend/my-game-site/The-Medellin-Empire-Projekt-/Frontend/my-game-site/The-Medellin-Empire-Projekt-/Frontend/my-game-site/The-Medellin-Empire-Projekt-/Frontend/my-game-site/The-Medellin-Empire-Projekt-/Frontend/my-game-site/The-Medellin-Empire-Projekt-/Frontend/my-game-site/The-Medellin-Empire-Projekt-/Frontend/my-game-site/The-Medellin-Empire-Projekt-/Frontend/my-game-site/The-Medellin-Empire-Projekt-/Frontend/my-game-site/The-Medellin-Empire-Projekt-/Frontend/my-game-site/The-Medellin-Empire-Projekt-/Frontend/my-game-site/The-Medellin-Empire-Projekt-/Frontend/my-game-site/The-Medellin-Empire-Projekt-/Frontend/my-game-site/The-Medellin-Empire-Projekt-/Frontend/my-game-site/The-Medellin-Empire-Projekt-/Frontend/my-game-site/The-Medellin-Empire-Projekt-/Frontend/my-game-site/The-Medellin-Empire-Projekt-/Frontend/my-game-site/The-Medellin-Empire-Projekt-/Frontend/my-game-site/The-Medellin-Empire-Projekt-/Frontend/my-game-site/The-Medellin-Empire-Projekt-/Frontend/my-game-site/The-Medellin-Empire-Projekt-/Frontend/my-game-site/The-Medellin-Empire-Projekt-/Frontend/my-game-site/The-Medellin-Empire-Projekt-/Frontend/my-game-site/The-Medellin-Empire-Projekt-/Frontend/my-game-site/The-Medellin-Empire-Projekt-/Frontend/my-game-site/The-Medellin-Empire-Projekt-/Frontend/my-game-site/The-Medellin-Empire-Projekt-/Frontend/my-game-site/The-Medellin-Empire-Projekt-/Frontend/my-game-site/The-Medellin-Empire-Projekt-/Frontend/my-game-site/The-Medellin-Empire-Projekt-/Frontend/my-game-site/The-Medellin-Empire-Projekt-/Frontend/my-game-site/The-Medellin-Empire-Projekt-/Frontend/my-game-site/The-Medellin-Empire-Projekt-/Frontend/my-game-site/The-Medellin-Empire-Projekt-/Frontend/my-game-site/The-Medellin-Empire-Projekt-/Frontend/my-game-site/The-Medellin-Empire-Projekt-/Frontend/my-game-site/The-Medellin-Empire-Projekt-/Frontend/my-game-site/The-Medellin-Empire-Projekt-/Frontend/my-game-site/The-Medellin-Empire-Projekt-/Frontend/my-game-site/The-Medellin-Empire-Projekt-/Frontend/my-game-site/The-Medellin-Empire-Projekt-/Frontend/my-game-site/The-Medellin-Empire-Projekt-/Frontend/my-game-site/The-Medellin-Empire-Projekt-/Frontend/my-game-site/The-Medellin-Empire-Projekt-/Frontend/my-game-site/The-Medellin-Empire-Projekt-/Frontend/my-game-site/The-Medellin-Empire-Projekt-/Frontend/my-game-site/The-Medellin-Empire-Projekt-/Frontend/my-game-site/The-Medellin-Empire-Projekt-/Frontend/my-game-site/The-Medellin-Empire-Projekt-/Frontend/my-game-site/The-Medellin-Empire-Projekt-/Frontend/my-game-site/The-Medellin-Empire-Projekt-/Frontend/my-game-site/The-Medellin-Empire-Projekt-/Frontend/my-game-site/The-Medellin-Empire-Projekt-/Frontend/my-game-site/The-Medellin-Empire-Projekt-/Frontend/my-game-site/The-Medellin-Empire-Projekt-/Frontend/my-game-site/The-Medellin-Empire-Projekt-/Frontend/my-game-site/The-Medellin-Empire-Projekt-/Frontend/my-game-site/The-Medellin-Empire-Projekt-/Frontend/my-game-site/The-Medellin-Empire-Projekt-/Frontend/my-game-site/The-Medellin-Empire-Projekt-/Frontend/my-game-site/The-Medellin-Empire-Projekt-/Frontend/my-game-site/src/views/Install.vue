<template>
  <section class="container" style="padding:120px 0 60px;">
    <h1 style="margin:0 0 14px;">Telepítési útmutató</h1>
    <p style="color:var(--muted); max-width:820px;">
      Az alábbi lépések végigvezetnek a <strong>The Medellin Empire</strong> telepítésén.
    </p>
